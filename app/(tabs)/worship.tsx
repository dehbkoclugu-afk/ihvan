...
export default function Worship() {
  ...
  return <Screen tabbed>
    ...
    <SectionHeader title={t('worship.dhikrCounter')} right={<View style={{ flexDirection: rowDirection(locale), gap: spacing.sm }}><Pressable accessibilityRole="button" onPress={() => router.push('/dhikr-history')} style={{ minHeight: 44, justifyContent: 'center' }}><Text style={{ color: theme.gold, fontFamily: fonts.sansSemiBold }}>{t('common.history')}</Text></Pressable><Pressable accessibilityRole="button" accessibilityLabel={t('worship.resetDhikrA11y')} onPress={reset} style={{ minHeight: 44, justifyContent: 'center' }}><Text style={{ color: theme.gold, fontFamily: fonts.sansSemiBold }}>{t('common.reset')}</Text></Pressable></View>} />
