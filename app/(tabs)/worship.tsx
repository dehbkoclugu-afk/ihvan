...
export default function Worship() {
  ...
  return <Screen tabbed>
    ...
    <SectionHeader title="Zikir sayacı" right={<Pressable accessibilityRole="button" accessibilityLabel="Bugünkü zikir sayacını sıfırla" onPress={reset}><Text style={{ color: t.gold, fontFamily: fonts.sansSemiBold }}>Sıfırla</Text></Pressable>} />
