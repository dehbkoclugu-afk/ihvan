...
export default function Profile() {
  ...
  return <Screen tabbed>
    ...
    <View style={{ flexDirection: 'row', alignItems: 'center', gap: spacing.sm, marginTop: spacing.md }}>
      ...
      <Pressable accessibilityRole="button" accessibilityLabel="Profil adını kaydet" accessibilityState={{ disabled: nameDraft.trim() === name }} onPress={saveName} disabled={nameDraft.trim() === name} style={({ pressed }) => ({ minHeight: 46, justifyContent: 'center', paddingHorizontal: spacing.lg, borderRadius: radius.inner, backgroundColor: t.gold, opacity: nameDraft.trim() === name ? 0.45 : pressed ? 0.75 : 1 })}><Text style={{ color: t.onGold, fontFamily: fonts.sansSemiBold, fontSize: 13 }}>Kaydet</Text></Pressable>
    </View>
