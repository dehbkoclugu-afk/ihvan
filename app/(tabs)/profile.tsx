...
export default function Profile() {
  ...
  return <Screen tabbed>
    ...
    <View style={{ backgroundColor: t.surface, borderRadius: radius.inner, padding: spacing.lg, marginTop: spacing.md }}><View style={{ flexDirection: 'row', alignItems: 'baseline' }}><Text style={{ color: t.gold, fontFamily: fonts.serif, fontSize: 28 }}>%{prayerWeek}</Text><Text style={{ color: t.inkSoft, fontFamily: fonts.sans, marginLeft: spacing.sm }}>son 7 gün namaz takibi</Text></View><View style={{ height: 5, borderRadius: 3, backgroundColor: t.surfaceAlt, marginTop: spacing.md }}><View style={{ width: `${prayerWeek}%`, height: 5, borderRadius: 3, backgroundColor: t.gold }} /></View></View>
