...
export default function Bookmarks() {
  ...
  return <Screen>
    ...
    <ScreenTitle style={{ marginTop: spacing.xl }}>{t('bookmarks.title')}</ScreenTitle>
    <ScreenSubtitle>{ayahs.length ? t('bookmarks.savedCount', { count: ayahs.length }) : t('bookmarks.empty')}</ScreenSubtitle>
