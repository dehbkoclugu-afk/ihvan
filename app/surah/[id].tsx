...
export default function SurahDetail() {
  ...
  return <Screen scrollRef={scrollRef}>
    ...
    <View style={{ alignItems: 'center', marginTop: spacing.xl }}><Text style={{ color: theme.ink, fontSize: 34, writingDirection: 'rtl', textAlign: 'right' }}>{surah.arabicName}</Text><Text style={{ color: theme.ink, fontFamily: fonts.serif, fontSize: 30, marginTop: spacing.sm, textAlign: 'center' }}>{surah.transliteration}</Text><Text style={{ color: theme.inkSoft, fontFamily: fonts.sans, marginTop: 5, textAlign: 'center' }}>{t('reader.surahMeta', { kind: t(surah.revelationPlace === 'meccan' ? 'quran.meccan' : 'quran.medinan'), count: surah.ayahCount })}</Text></View>
